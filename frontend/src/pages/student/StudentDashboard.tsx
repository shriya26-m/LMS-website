...
export default function StudentDashboard() {
    ...
    // Build activity data from real progress update timestamps
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="mt-2">
                                                    ...
                                                    <div className="w-full bg-gray-100 dark:bg-slate-700 rounded-full h-1.5 overflow-hidden">
                                                        <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-500 h-full rounded-full transition-all duration-500 animate-pulse-subtle"
                                                            style={{ width: `${p.progressPercent}%` }} />
                                                    </div>
                                                </div>
                                            </div>
                                            <button className="p-2.5 rounded-xl bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition flex-shrink-0 self-center shadow-sm">
