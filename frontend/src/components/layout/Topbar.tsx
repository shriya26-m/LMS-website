                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="relative hidden md:block">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 bg-gray-100 dark:bg-slate-800 border border-transparent rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 w-52 transition text-white placeholder-slate-400"
                        />
                    </div>
                    ...
                    <div className="relative" ref={notifRef}>
                        <button onClick={() => setShowNotifications(!showNotifications)}
                            className="relative p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-slate-800 transition text-gray-300">
