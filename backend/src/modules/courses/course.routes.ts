...
import {
    ...
    getAdminAllCourses, getMonthlyEnrollments
...
router.get('/admin-all', authenticate, authorize('admin'), getAdminAllCourses);
router.get('/monthly-enrollments', authenticate, authorize('admin'), getMonthlyEnrollments);
